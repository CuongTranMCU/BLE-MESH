...
//     }
// }
// // fucntion send to client:
// void server_model_send_to_client (uint8_t onoff)
// {
//       esp_ble_mesh_gen_onoff_state_t state; // giá trị hiện tại.
//       state.onoff = onoff;

//       esp_ble_mesh_model_publish(onoff_server_0.model, ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS,
//              sizeof(state.onoff), &state.onoff, ROLE_NODE);// gửi vào group address đã được subcribe của client.
...
//             // gửi lại bản tin status cho client
//         break;
//     case ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_SET: // SET, SETUNACK: cập nhật data.
...
//             srv->state.onoff = set->onoff;
//         }
//         // có ack -> gửi lại client nữa
//         if (ctx->recv_op == ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_SET) {
//             esp_ble_mesh_server_model_send_msg(model, ctx,
//                 ESP_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS, sizeof(srv->state.onoff), &srv->state.onoff);
//         }
//         // else: không cần làm gì cả.
...
//     switch (event) {
//     case ESP_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT: // nếu để auto rsp thì mặc định sẽ nhảy vào cái này.
...
//         }
//         break;
//     case ESP_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT: // nhận tin  GET
...
//         }
//         break;
//     case ESP_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT: //nhận tin SET
...
//     esp_ble_mesh_register_prov_callback(example_ble_mesh_provisioning_cb); // quá tình provision
//     esp_ble_mesh_register_config_server_callback(example_ble_mesh_config_server_cb);// config pub,sub,addr  
//     esp_ble_mesh_register_generic_server_callback(example_ble_mesh_generic_server_cb);// model on/off.
...
//     ESP_LOGI(TAG, " SERVER Initializing..");
...
//     err = ble_mesh_init(); // quan trọng nhất.
//     if (err) {
