...
import 'package:ble_mesh/ui/home/users/floor_info.dart';
import 'package:ble_mesh/ui/home/users/user_floor_item.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../../../cloud_services/rtdb_service_ble.dart';
import '../../../../models/monitor_data.dart';

class UserListOfFloors extends StatefulWidget {
  const UserListOfFloors({super.key, required this.context});

  final BuildContext context;

  @override
  State<UserListOfFloors> createState() => _UserListOfFloorsState();
}

class _UserListOfFloorsState extends State<UserListOfFloors> {
                ...
                return UserFloorItem(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UserFloorInfo(floorName: floorName),
                      ),
                    );
                  },
                );
