...
import 'package:ble_mesh/ui/home/admin/admin_group/select_node.dart';
...
import 'custom_widget/current_node_widget.dart';
import 'custom_widget/list_nodes_widget.dart';
              ...
              children: [
                ...
                Expanded(
                  child: ListNodesWidget(
                    ...
                    onRemove: () => selectedIndex = ((selectedIndex != 0) ? selectedIndex - 1 : 0),
